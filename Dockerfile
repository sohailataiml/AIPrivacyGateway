...
# The spaCy model is a large, stable artifact -- keep it in its own layer.
RUN --mount=type=cache,target=/root/.cache/uv \
    /build/.venv/bin/python -m spacy download en_core_web_lg
